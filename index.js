...
module.exports = React.createClass({displayName: "exports",
    render: function () {
        ...
        var appender = {
            'エンハンサー': function () {
                return (
                    React.createElement("div", {className: "panel"}, inputTable('techniques', [
                        {key: 'name', label: '練技'},
                        {key: 'effect', label: '効果'}
                    ]))
                );
            ...
            'ライダー': function () {
                return (
                    React.createElement("div", {className: "panel"}, inputTable('riding_skills', [
                        {key: 'name', label: '騎芸'},
                        {key: 'effect', label: '効果'}
                    ]))
                );
            ...
            'アルケミスト': function () {
                return (
                    React.createElement("div", {className: "panel"}, inputTable('alchemist_skills', [
                        {key: 'name', label: '賦術'},
                        {key: 'card', label: 'カード'},
                        {key: 'effect', label: '効果'}
                    ]))
            ...
            'ウォーリーダー': function () {
                return (
                    React.createElement("div", {className: "panel"}, inputTable('warleader_skills', [
                        {key: 'name', label: '鼓咆'},
                        {key: 'effect', label: '効果'}
                    ]))
                );
            ...
            'ミスティック': function () {
                return (
                    React.createElement("div", {className: "panel"}, inputTable('mistic_skills', [
                        {key: 'name', label: '占瞳'},
                        {key: 'item', label: '占具'},
                        {key: 'effect', label: '効果'}
                    ]))
...
},{"../InputContainer":1,"../InputTable":2}],4:[function(require,module,exports){
'use strict';
...
},{"./Character":3,"axios":5}],5:[function(require,module,exports){
